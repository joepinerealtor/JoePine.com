    ...
    buyer: {
        ...
        stages: [
            ...
            },
            {
                ...
                summary: "The appraisal is done, which means we are heading into mortgage commitment and getting closer to the lender's real green light.",
                what: "Your lender and underwriting team verify the remaining details in your file and work toward issuing the formal mortgage commitment.",
                why: "Once commitment lands, financing moves from in progress to approved, and that is one of the biggest milestones in the entire deal.",
                note: "This is the part where speed matters. If the lender asks, answer fast.",
                checklist: [
                    "Send lender documents back as quickly as possible.",
                    "Finalize moving plans so the last week is less chaotic.",
                    "Ask Joe if any lender request looks confusing before you send it.",
                ],
            },
            {
    ...
    seller: {
        ...
        stages: [
            ...
            },
            {
                ...
                summary: "The appraisal is done, and now the buyer moves into mortgage commitment, which is a major financing checkpoint.",
                what: "While the buyer's lender works through final approval, this is the sweet spot for you to get ahead on packing and moving logistics.",
                why: "Once commitment is in, the path to closing usually feels a whole lot stronger and more predictable.",
                note: "This is a great time to get moving before closing week gets hectic.",
                checklist: [
                    "Pack the non-essentials first and label boxes clearly.",
                    "Set aside a closing-week bin for chargers, meds, and daily must-haves.",
                    "Confirm movers, parking, or building logistics now if needed.",
                ],
            },
            {
                slug: "mortgage-commitment",
